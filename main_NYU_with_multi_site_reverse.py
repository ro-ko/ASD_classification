...
from data_preprocessing import data_loader, cls_data_loader
from metric import accuracy, sensitivity, specificity, get_clf_eval
from model import GAT, GCN, ChebyNet, GATR, GIN, ChebyNetR
...
def main(seed, timestamp):
    ...
    test_loss, test_acc, test_sen, test_spe, test_f1 = trainer(args, seed, train_x, NYU_test, train_label, train_group, NYU_test_label)
